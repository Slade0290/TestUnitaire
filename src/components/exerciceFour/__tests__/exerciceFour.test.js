...
it('should call decrement once', () => {
    ...
    const component = shallow(<ExerciceFour counterNumber={0} counterTitle="title" decrement={decrementMock} />)
...
it('should call increment once', () => {
    ...
    const component = shallow(<ExerciceFour counterNumber={0} counterTitle="title" increment={incrementMock} />)
